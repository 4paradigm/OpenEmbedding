...
void c_api_persist_threads(int node_num, int var_num, int var_type, int reps, int shard_num = -1) {
...
TEST(pmem_c_api, one_node_persist) {
    yaml_config = "{\"server\":{\"pmem_pool_root_path\":\"/mnt/pmem0/tmp/exb_pmem_test\", \"cache_size\":10 }}";
    c_api_persist_threads(1, 3, 1, 100);
    c_api_persist_threads(1, 3, 3, 100);
    yaml_config = "";
    core::FileSystem::rmrf("/mnt/pmem0/tmp/exb_pmem_test");
}
...
TEST(pmem_c_api, three_node_persist) {
    yaml_config = "{\"server\":{\"pmem_pool_root_path\":\"/mnt/pmem0/tmp/exb_pmem_test\", \"cache_size\":10 }}";
    c_api_persist_threads(3, 5, 1, 100);
    c_api_persist_threads(3, 5, 5, 100);
    yaml_config = "";
    core::FileSystem::rmrf("/mnt/pmem0/tmp/exb_pmem_test");
}
...
TEST(pmem_c_api, one_node_small_cache) {
    ...
    c_api_persist_threads(1, 3, 1, 10);
    c_api_persist_threads(1, 3, 3, 10);
    yaml_config = "";
    core::FileSystem::rmrf("/mnt/pmem0/tmp/exb_pmem_test");
}

TEST(pmem_c_api, three_node_small_cache) {
    yaml_config = "{\"server\":{\"pmem_pool_root_path\":\"/mnt/pmem0/tmp/exb_pmem_test\", \"cache_size\":0 }}";
    c_api_persist_threads(3, 5, 1, 10);
    c_api_persist_threads(3, 5, 5, 10);
    yaml_config = "";
    core::FileSystem::rmrf("/mnt/pmem0/tmp/exb_pmem_test");
}
